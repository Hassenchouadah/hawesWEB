(function ($) {
    ...
    $(".ticket-calendar-info").hide();
    $('.startDate, .toDate').daterangepicker({
    ...
    $('.add-to-cart').click(function (event) {
        ...
        if ($('.startDate').val() == "") {
            ...
            $('.booking-warning').html('You should select a date.');
        ...
        if (!flag) {
            $('.booking-warning').show();
            $('.booking-warning').html('You should select participants.');
            event.preventDefault();
        }
    });
    ...
    var arr = ["service", "money", "trns", "safety", "undrstd", "smiling", "prsnt", "timing"];
    jQuery.each(arr, function (i, val) {
        var $rating = $("#rating_" + val);
        $("#" + val).starrr({
            rating: $rating.val(),
            change: function (e, value) {
                $rating.val(value).trigger("#rating_" + val);
                if (value) {
                    $('.your-choice-was-' + val).show();
                    $('.choice-' + val).text(value);
                } else {
                    $('.your-choice-was-' + val).hide();
                }
            }
        });
    });
